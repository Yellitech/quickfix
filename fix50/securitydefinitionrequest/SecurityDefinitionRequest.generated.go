...
func (m SecurityDefinitionRequest) SetSubscriptionRequestType(f SubscriptionRequestTypeRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m SecurityDefinitionRequest) GetSubscriptionRequestType() (SubscriptionRequestTypeRepeatingGroup, quickfix.MessageRejectError) {
	f := NewSubscriptionRequestTypeRepeatingGroup()
	err := m.GetGroup(f)
	return f, err
}
...
//SubscriptionRequestType is a repeating group element, Tag 263
type SubscriptionRequestType struct {
	*quickfix.Group
}

//SetLegOptionRatio sets LegOptionRatio, Tag 1017
func (m SubscriptionRequestType) SetLegOptionRatio(value decimal.Decimal, scale int32) {
	m.Set(field.NewLegOptionRatio(value, scale))
}

//SetLegPrice sets LegPrice, Tag 566
func (m SubscriptionRequestType) SetLegPrice(value decimal.Decimal, scale int32) {
	m.Set(field.NewLegPrice(value, scale))
}

//GetLegOptionRatio gets LegOptionRatio, Tag 1017
func (m SubscriptionRequestType) GetLegOptionRatio() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SubscriptionRequestType) GetLegPrice() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SubscriptionRequestType) HasLegOptionRatio() bool {
	return m.Has(tag.LegOptionRatio)
}

//HasLegPrice returns true if LegPrice is present, Tag 566
func (m SubscriptionRequestType) HasLegPrice() bool {
	return m.Has(tag.LegPrice)
}

//SubscriptionRequestTypeRepeatingGroup is a repeating group, Tag 263
type SubscriptionRequestTypeRepeatingGroup struct {
	*quickfix.RepeatingGroup
}

//NewSubscriptionRequestTypeRepeatingGroup returns an initialized, SubscriptionRequestTypeRepeatingGroup
func NewSubscriptionRequestTypeRepeatingGroup() SubscriptionRequestTypeRepeatingGroup {
	return SubscriptionRequestTypeRepeatingGroup{
		quickfix.NewRepeatingGroup(tag.SubscriptionRequestType,
			quickfix.GroupTemplate{quickfix.GroupElement(tag.LegOptionRatio), quickfix.GroupElement(tag.LegPrice)})}
}

//Add create and append a new SubscriptionRequestType to this group
func (m SubscriptionRequestTypeRepeatingGroup) Add() SubscriptionRequestType {
	g := m.RepeatingGroup.Add()
	return SubscriptionRequestType{g}
}

//Get returns the ith SubscriptionRequestType in the SubscriptionRequestTypeRepeatinGroup
func (m SubscriptionRequestTypeRepeatingGroup) Get(i int) SubscriptionRequestType {
