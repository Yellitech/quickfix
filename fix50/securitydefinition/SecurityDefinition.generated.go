...
func (m SecurityDefinition) SetClearingBusinessDate(f ClearingBusinessDateRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m SecurityDefinition) GetClearingBusinessDate() (ClearingBusinessDateRepeatingGroup, quickfix.MessageRejectError) {
	f := NewClearingBusinessDateRepeatingGroup()
	err := m.GetGroup(f)
	return f, err
}
...
//ClearingBusinessDate is a repeating group element, Tag 715
type ClearingBusinessDate struct {
	*quickfix.Group
}

//SetLegOptionRatio sets LegOptionRatio, Tag 1017
func (m ClearingBusinessDate) SetLegOptionRatio(value decimal.Decimal, scale int32) {
	m.Set(field.NewLegOptionRatio(value, scale))
}

//SetLegPrice sets LegPrice, Tag 566
func (m ClearingBusinessDate) SetLegPrice(value decimal.Decimal, scale int32) {
	m.Set(field.NewLegPrice(value, scale))
}

//GetLegOptionRatio gets LegOptionRatio, Tag 1017
func (m ClearingBusinessDate) GetLegOptionRatio() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m ClearingBusinessDate) GetLegPrice() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m ClearingBusinessDate) HasLegOptionRatio() bool {
	return m.Has(tag.LegOptionRatio)
}

//HasLegPrice returns true if LegPrice is present, Tag 566
func (m ClearingBusinessDate) HasLegPrice() bool {
	return m.Has(tag.LegPrice)
}

//ClearingBusinessDateRepeatingGroup is a repeating group, Tag 715
type ClearingBusinessDateRepeatingGroup struct {
	*quickfix.RepeatingGroup
}

//NewClearingBusinessDateRepeatingGroup returns an initialized, ClearingBusinessDateRepeatingGroup
func NewClearingBusinessDateRepeatingGroup() ClearingBusinessDateRepeatingGroup {
	return ClearingBusinessDateRepeatingGroup{
		quickfix.NewRepeatingGroup(tag.ClearingBusinessDate,
			quickfix.GroupTemplate{quickfix.GroupElement(tag.LegOptionRatio), quickfix.GroupElement(tag.LegPrice)})}
}

//Add create and append a new ClearingBusinessDate to this group
func (m ClearingBusinessDateRepeatingGroup) Add() ClearingBusinessDate {
	g := m.RepeatingGroup.Add()
	return ClearingBusinessDate{g}
}

//Get returns the ith ClearingBusinessDate in the ClearingBusinessDateRepeatinGroup
func (m ClearingBusinessDateRepeatingGroup) Get(i int) ClearingBusinessDate {
